package com.treasurehunting.java.gameobjects;
...
public abstract class GameObject {
    ...
    public GameObject(SpriteSheet startSpriteSheet, Vector2f pos, float r) {
        spriteSheets = new HashMap<>();
        // IDLE anim first
        spriteSheets.put(0, startSpriteSheet);
        ...
        width = (int) r;
        height = (int) r;
        bounds = new AABB(new Vector2f(pos.x + width / 2 - 500 / 2, pos.y + height / 2 - 500 / 2), 500);
        sense = new AABB(new Vector2f(pos.x + width / 2 - 500 / 2, pos.y + height / 2 - 500 / 2), 500);
