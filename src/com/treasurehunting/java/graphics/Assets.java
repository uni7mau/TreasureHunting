...
//    public static final int TILE_SIZE = 32;
    ...
    static {
        fontf = new Fontf();
        fontf.loadFont(Assets.pixelCandyFont, "Pixel Game", 512);
        fontf.addSize("Pixel Game", java.awt.Font.PLAIN, 128);
    ...
    public static String graveMazeMap = "com/treasurehunting/assets/tile/GraveMaze.xml";

    public static int getNormLayerIndex() {
        if (currMapID == takeMapID(dungeonMap)) {
            return 3;
        } else if (currMapID == takeMapID(graveMazeMap)) {
            return 1;
        }
    ...
    public static int lastMapID = takeMapID(graveMazeMap);
    ...
    public static int takeMapID(String fileURL) {
        if (fileURL.equals(dungeonMap)) {
            return 0;
        } else if (fileURL.equals(graveMazeMap)) {
            return 1;
        }
